...
#pragma mark 这里是新加的，系统没有，单击隐藏浏览视图
...
//    
//    [singleTapGR requireGestureRecognizerToFail:doubleTapGesture];
 ...
 *  后面加的
 */
- (void)setphotoCount:(NSUInteger)count{
    _photoCount = count;
}
