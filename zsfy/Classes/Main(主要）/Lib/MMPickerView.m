...
-(void)initializePickerViewInView: (UIView *)view
  ...
  UIColor *pickerViewBackgroundColor = [[UIColor alloc] initWithCGColor:[[UIColor whiteColor] CGColor]];
  UIColor *pickerViewTextColor = [[UIColor alloc] initWithCGColor:[[UIColor grayColor] CGColor]];
  UIColor *toolbarBackgroundColor = nil;
  UIColor *buttonTextColor = nil;
  UIFont *pickerViewFont = [[UIFont alloc] init];
    pickerViewFont = [UIFont systemFontOfSize:18];
  ...
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, Screen_Height - 260, Screen_Width, 260.0)];
...
//    [_pickerViewBarButtonItem setTitle:@"确定"];
  _pickerViewBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"确定" style:UIBarButtonItemStyleDone target:self action:@selector(dismiss)];
    ...
    [_pickerViewBarButtonItem setTitleTextAttributes:attrs forState:UIControlStateNormal];
